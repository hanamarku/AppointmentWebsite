...
namespace Online_Appointment.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { Firstname = model.Firstname, Lastname = model.Lastname, UserName = model.UserName, Email = model.Email, Birthday = model.Birthday, CreatedOn = System.DateTime.Now, PhoneNumber = model.PhoneNumber };
